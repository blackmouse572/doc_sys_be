...
import { IFilter, ISingleFilter, ISingleOrder } from './filter.dto';
...
export class FilterBuilder<T = any> {
  ...
  /**
   * This function builds a query string.
   * @param paramName The name of the parameter to add.
   * @param array The array to build the query string from.
   */
  ...
  public addFilter(
    ...
    // If the filter array does not exist, create it
